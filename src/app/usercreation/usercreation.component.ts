...
export class UsercreationComponent implements OnInit {
  ...
  cols = [
    ...
    { header: "Email ID", width: '5%' },
    { header: 'Phone Number', width: '9%' },
    { header: 'Role', width: '9%' },
  ...
  getUserData() {
    ...
    this.apiService.getApi(environment.getUser + '?firstName=' + firstName + '&lastName=' + lastName + '&role=' + role + '&page=' + this.pageNo + ' &size=' + this.pageSize).subscribe((res) => {
      console.log(res);
  ...
  addUser() {
    if (this.createForm.invalid) {
      ...
      this.apiService.postApi(environment.addUser, data).subscribe((res) => {
        if (res.success == true) {
  ...
  updateUser() {
    if (this.editForm.invalid) {
      ...
      this.apiService.putApi(environment.updateUser + this.userId, data).subscribe((res) => {
        console.log(res);
        if (res) {
          this.messageService.add({ severity: "success", summary: "Success", detail: res.message });
  ...
  confirmDelete(data: any, event: Event) {
    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        this.apiService.deleteApi(environment.deleteUser + data.id).subscribe(res => {
          console.log(res);
          if (res) {
            this.messageService.add({ severity: "success", summary: "Success", detail: res.message });
            this.getUserData()
