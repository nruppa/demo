...
export class VendorReportsComponent implements OnInit {
  ...
  generateReport() {
    ...
    this.apiService.getApi(environment.vendorPiechartReports, { params: params }).subscribe((res) => {
      console.log(res);
    ...
    this.apiService.getApi(environment.vendorReportsTable, { params: params }).subscribe((res) => {
      console.log(res);
